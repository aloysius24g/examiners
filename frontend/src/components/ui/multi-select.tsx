				...
				<Popover
												...
												return (
													<Badge
														...
														<div
															...
															className="ml-2 h-4 w-4 cursor-pointer hover:bg-white/20 rounded-full -m-0.5 focus:outline-none focus:ring-1 focus:ring-white/50">
															<XCircle
																className={cn(
																	"h-3 w-3",
																	responsiveSettings.compactMode &&
					...
					<PopoverContent
						...
						className={cn(
							...
							screenSize === "tablet" && "w-[40vw] max-w-md",
